...
stock_data <- read.csv("/Users/iamy8000/Desktop/UMD MIM/INST737/milestone 3/StockPrediction_data_apple.csv")
...
# Tuning
hidden_configurations <- list(c(10, 10, 10), c(30, 30, 30), c(50, 50, 50)) #c(1),c(3),c(5),c(10),c(30)
